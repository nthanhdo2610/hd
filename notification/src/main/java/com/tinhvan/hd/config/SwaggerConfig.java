...
public class SwaggerConfig {
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Notification REST CRUD operations API in Spring-Boot 2")
                .description("Sample REST API for notification documentation using Spring Boot and spring-fox swagger 2 ")
