...
public class ContractLoan {
    ...
    public void init(ContractLoanRequest request){
        contractUuid=UUID.fromString(request.getContractUuid());
        duration=request.getDuration();
        interestRate=request.getInterestRate();
        loanAmount=request.getLoanAmount();
        remainingDebt=request.getRemainingDebt();
        monthlyDueDate=request.getMonthlyDueDate();
        remainingDebtModifiedAt=request.getRemainingDebtModifiedAt();
        isReminder=request.getIsReminder();
        loanCategory=request.getLoanCategory();
        monthlyInstallmentAmount=request.getMonthlyInstallmentAmount();
        insuranceCategory=request.getInsuranceCategory();
