...
@SequenceGenerator(name = "SEQ_STORE", sequenceName = "NOTIFICATION_GROUP_QUEUE_SEQ", allocationSize = 1)
public class NotificationGroupQueue implements Serializable {
